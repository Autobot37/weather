...
model = TrajGRU(1, 64, [32, 480, 480])
model.to(device)

summary(model, (args.batch_size,10, 480, 480))
...
for epoch in range(args.epochs):
    ...
    with torch.no_grad():
        for x_val, y_val in val_loader:
            ...
            val_loss = args.alpha*pcc_loss_batch(pred, y) + (1-args.alpha) * mse_loss(pred, y)
    ...
    if not os.path.exists('/home/vatsal/Supreme/Mosdac_model_weights/PCC_MSE_withoutprevdays/'):
        os.makedirs('/home/vatsal/Supreme/Mosdac_model_weights/PCC_MSE_withoutprevdays/', exist_ok=True)



    if val_losses < best_val_loss:
        best_val_loss = val_loss
        torch.save(model.state_dict(), f'/home/vatsal/Supreme/Mosdac_model_weights/PCC_MSE_withoutprevdays/Best_FNO_{args.optimizer}_{args.learning_rate}_{args.batch_size}_{args.modes}_{args.hidden_channels}.pt')  # save best checkpoint
...
state_dict = torch.load(f'/home/vatsal/Supreme/Mosdac_model_weights/PCC_MSE_withoutprevdays/Best_FNO_{args.optimizer}_{args.learning_rate}_{args.batch_size}_{args.modes}_{args.hidden_channels}.pt', weights_only=False)
...
plot_predictionmetric_scores2(f"/home/vatsal/MOSDAC/predictions2/FNO_2_PCC_MSE_withoutprevdays/FNO_{args.optimizer}_{args.learning_rate}_{args.batch_size}_{args.modes}_{args.hidden_channels}", x_test_lis, y_test_lis, y_pred_lis, len(x_test_lis), args.sequence_length)