...
from pipeline.modeldefinitions.taming.vae import Encoder, Decoder
from pipeline.modeldefinitions.taming.distributions import DiagonalGaussianDistribution
...
class AutoencoderKL(nn.Module):
    ...
    def __init__(
        ...
        self.encoder_flat_size = 12 * 12 * latent_channels * 2 # 1152 or 576 ffor means and 576 for logvars
        self.bottleneck_dim = bottleneck_dim
        
        self.to_bottleneck = nn.Linear(self.encoder_flat_size, 2 * bottleneck_dim)
        self.from_bottleneck = nn.Linear(bottleneck_dim, self.encoder_flat_size // 2)
