...
if __name__ == "__main__":
    ...
    x = torch.randn(2, T_in, 1, 128, 128)  # (batch_size, T_in, channels, height, width
    time = torch.randint(0, 1000, (2,))  # Random time steps
    cond = torch.randn(2, T_in, 1, 128, 128)  # Conditional input
    out = unet(x, time, cond = cond)
    print(out.shape)  # Should be (2, T_in, dim, 64, 64)