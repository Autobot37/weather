...
from pipeline.modeldefinitions.taming import AutoencoderKL, LPIPSWithDiscriminator
...
class VAESEVIRPLModule(pl.LightningModule):
    ...
    def __init__(self):
        ...
        model_cfg = OmegaConf.load("/home/vatsal/NWM/weather/pipeline/configs/models/vae.yaml")
