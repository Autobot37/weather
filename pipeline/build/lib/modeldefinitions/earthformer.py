from earthformer.model.cuboid_transformer import CuboidTransformerModel
...
def instantiate_model(model_cfg):
    ...
    enc_patterns = to_list(model_cfg.self_pattern)
    ...
    transformer = CuboidTransformerModel(
        ...
        enc_attn_patterns=enc_patterns,
        dec_self_attn_patterns=dec_self_patterns,
        dec_cross_attn_patterns=dec_cross_patterns,
