...
model_6 = onnx.load('fengwu_v1.onnx')
...
ort_session_6 = ort.InferenceSession('fengwu_v1.onnx', sess_options=options, providers=[('CUDAExecutionProvider', cuda_provider_options)])
