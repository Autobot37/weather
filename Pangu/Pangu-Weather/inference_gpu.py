...
model_add = 'models/pangu_weather_6.onnx'
model_24 = onnx.load(model_add)
...
ort_session_24 = ort.InferenceSession(model_add, sess_options=options, providers=[('CUDAExecutionProvider', cuda_provider_options)])
